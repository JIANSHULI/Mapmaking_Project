...
for nSide = 1:4
    ...
    for a = 1:nSide
        for d = 1:nSide
            ...
            fprintf(fileID,'frequency = 125.586\n');
            fprintf(fileID,'polarization = yy\n');
            fprintf(fileID,'baselinesFile = ../GSM_Visibilities/2Deg_FWHM/IntendedUniqueBaselines.dat\n');
            fprintf(fileID,'visibilitiesFolderAndPrefix = ../GSM_Visibilities/2Deg_FWHM/Revised_Location_Visibilties_for_\n');
            ...
            fprintf(fileID,'dataProductFilePrefix = /nfs/pritchard/r1/jsdillon/Mapmaking_Results/2Deg_FWHM/Results_Facet_Size/%d_%d_%d_\n',nSide,a,d);
            ...
            fprintf(fileID,'primaryBeamFWHM = 2.0\n');
            fprintf(fileID,'xpolOrientationDegreesEastofNorth = 90.0\n');
            fprintf(fileID,'maximumAllowedAngleFromPBCenterToFacetCenter = 2\n');
